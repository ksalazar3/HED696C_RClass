...
- Work through material from lecture 9 that we don't get to in class
...
- [OPTIONAL] GW chapter 12 (tidy data)
    - Lecture 9 covers this material pretty closely, so read chapter if you can, but I get it if you don't have time
