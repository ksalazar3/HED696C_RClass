...
- [Required] GW chapter 5 (tidying data)


### Libraries we will use today 

Functions we will use today, install the tidyr package: 
```{r}
...
Wickham chapter 5: "There are three interrelated rules which make a dataset tidy:
...
"These three rules are interrelated because it’s impossible to only satisfy two of the three" (Wickham chapter 5)
...
- how would you calculate a `rate` per 10,000 variable (`=cases/population*10000`) for `table1` (tidy) and `table2` (untidy)
