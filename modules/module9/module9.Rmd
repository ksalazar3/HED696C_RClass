...
if(!file.exists('tidyverse.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/tidyverse.png', 
...
if(!file.exists('mrc_table1.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/mrc_table1.png', 
...
if(!file.exists('ic2017_ay.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/ic2017_ay.png', 
...
if(!file.exists('rclass_folder.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/rclass_folder.png', 
...
if(!file.exists('rclass_folder_contents.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/rclass_folder_contents.png', 
...
- First make sure to save __module10.Rmd__ in your lectures folder  
    - If you do not have class folder structure, you can download it [here](https://github.com/ksalazar3/HED696C_Rclass/raw/master/rclass.zip)
- Download and unzip data folder we are using for this lecture [here](https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture10/lecture10_data.zip) 
