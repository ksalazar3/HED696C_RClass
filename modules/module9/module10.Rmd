---
title: "Module 10: Joining multiple datasets"
...
if(!file.exists('join-setup.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture7/join-setup.png', 
...
if(!file.exists('join-inner.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture7/join-inner.png', 
...
if(!file.exists('join-many-to-one.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture7/join-many-to-one.png', 
...
if(!file.exists('join-outer.png')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture7/join-outer.png', 
...
if(!file.exists('lecture1.2.R')){
  download.file(url = 'https://github.com/ksalazar3/HED696C_Rclass/raw/master/lectures/lecture1/lecture1.2.R', 
...
- Work through slides we from lecture 9 that we don't get to in class
...
- [RECOMMENDED] GW chapter 13 (Relational data)
    - Lecture 9 covers this material pretty closely. Please read chapter if you can, but I get it if you don't have time
...
#getwd()
nls_stu <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/nls72/nls72stu_percontor_vars.dta") %>%
...
```{r}
nls_stu_pets <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/nls72/nls72petsstu_v2.dta") %>%
...
```{r}
nls_tran <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/nls72/nls72petstrn_v2.dta") %>%
...
```{r}
nls_term <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/nls72/nls72petstrm_v2.dta") %>%
...
```{r}
nls_course <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/nls72/nls72petscrs_v2.dta") %>%
...
admit16_17 <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/ipeds/ic/ic16_17_admit.dta") %>%
...
admit15_16 <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/ipeds/ic/ic15_16_admit.dta") %>%
  select(unitid,endyear,sector,contains("admcon"),contains("numapply"),contains("numadmit"))

admit14_15 <- read_dta(file="https://github.com/ksalazar3/HED696C_Rclass/raw/master/data/ipeds/ic/ic14_15_admit.dta") %>%
  select(unitid,endyear,sector,contains("admcon"),contains("numapply"),contains("numadmit"))
