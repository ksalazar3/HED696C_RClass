...
1. Use `select` to create (you must use the assignment operator) a new object called `df_school_v2` that only includes the following variables from `df_school`: `ncessch`, `school_type`, `school_name`, `pct_white`, `avgmedian_inc_2564`, and `visits_by_110635`
...
1. Use `head` to print the top 5 public high schools visited by UC Berkeley with the largers percent of enrolled students that identify as White 
