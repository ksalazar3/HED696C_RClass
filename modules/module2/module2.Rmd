...
- Download the module2 Rmd and R script lecture files from the class website [https://ksalazar3.github.io/HED696C_RClass/](https://ksalazar3.github.io/HED696C_RClass/)
- Move the files to "HED696C_RClass/modules/module2"
...
__After you're done, take a 10 min break__
...
What if you wanted to count the number of schools visited by Bama (100751) in a group of states (MA, VT, ME)?
```{r}
...
- Module 2 Problem Set due on 9/19/2022
  - Rmd file is on course website; you'll need to download it and move it to the "HED696C_RClass/problemsets/module2" folder
  - Knit the file to HTML before you begin!
- Reading for 9/19/2022
  - [Wickham, Advanced R](https://adv-r.hadley.nz/) 
    - Sections 4.1-4.4
  - [Teach youself R in 24 Hours](https://arizona-primo.hosted.exlibrisgroup.com/permalink/f/1h28lag/TN_cdi_safari_books_v2_9780134288819) 
    - Hour 11, section on “Sorting” [about 3 pages]